...
const Cardboard = () => {
  ...
  const [ controlManual, setControlManual ] = useState(false);
  const [ controlCardboard, setControlCardboard ] = useState(false);
  ...
  const onClick = () => { 
      ...
      setControlManual(!controlManual);
      setControlCardboard(!controlCardboard);
  ...
  return (
    <span className={"toggle-cardboard hide" + (active ? 'is-active' : '')} onClick={onClick}>
